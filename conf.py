...
project = 'QuantEcon DataScience'
copyright = '2020, Chase Coleman, Spencer Lyon, and Jesse Perla'
...
exclude_patterns = ['_build', '_static', 'sandbox']
...
html_title = "Datascience for Economists"
...
htmlhelp_basename = 'QuantEcondslectures-python3doc'
...
latex_documents = [
    (master_pdf_doc, 'QuantEconlectures-python3.tex',
     'QuantEcon.lectures-python3 PDF', 'Thomas J. Sargent and John Stachurski',
     'manual'),
]
...
# Anchors on Github seem to create issues with linkchecker
