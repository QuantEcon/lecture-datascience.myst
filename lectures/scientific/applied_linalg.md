...
```{figure} https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/lectures/_static/vector.png
:alt: vector.png
```
...
```{figure} https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/lectures/_static/mat_mult_wiki_bilou.png
:alt: matmult.png
```
