...
```{code-cell} python
state_df = gpd.read_file("https://www2.census.gov/geo/tiger/GENZ2016/shp/cb_2016_us_state_5m.zip")
state_df.head()
```
...
```{code-cell} python
county_df = gpd.read_file("https://www2.census.gov/geo/tiger/GENZ2016/shp/cb_2016_us_county_5m.zip")
county_df.head()
```
