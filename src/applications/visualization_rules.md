...
```{code-cell} python
# Read in data
df = pd.read_csv("https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/src/applications/density_wage_data.csv")
...
```{figure} https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/src/_static/HSV_color_solid_cylinder_saturation_gray.png
...
```{figure} https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/src/_static/bar_grayscale.png
...
```{figure} https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/src/_static/Divided-nation.jpg
...
```{code-cell} python
download_url = "https://raw.githubusercontent.com/QuantEcon/lecture-datascience.myst/main/src/applications/WorldBank_AgeDependencyRatio.csv"
